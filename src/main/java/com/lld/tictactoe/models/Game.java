...
public class Game {
   ...
   private Game(int dimesion, List<Player> players, List<WinningStrategy> winningStrategies){
       board = new Board(dimesion);
       ...
       System.out.printf("Game Created");
   }
   ...
   public static class Builder{
       ...
       // while creating object with builder, only the attributes which are reuired can be mentioned.
      ...
      private void validatePlayerCount() throws PlayerCountException{
       ...
       private void validateBotCount() throws BotCountException{
          ...
          if(countOfBot >1) throw new BotCountException();
